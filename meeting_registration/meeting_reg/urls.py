...
urlpatterns = [
    ...
    path('teachers_dump', views.appointments_dump_for_teachers, {"with_emails": False}),
    path('teachers_dump_with_emails', views.appointments_dump_for_teachers, {"with_emails": True}),
